...
public class MiaFinestraMedesima extends JFrame implements ActionListener {
    ...
    public MiaFinestraMedesima(String titolo, int larghezza, int altezza){
        super(titolo);
        init(larghezza,altezza);
        initListener();
    }
    public MiaFinestraMedesima(String titolo){
        super(titolo);
        init(LARGHEZZA,ALTEZZA);
        initListener();
    } 
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == btnConferma) System.out.println("Hai cliccato il pulsante CONFERMA. Sono l'ascoltatore della classe MEDESIMA");
        else System.out.println("Hai cliccato il pulsante ANNULLA. Sono l'ascoltatore della classe MEDESIMA");
