...
public class MiaFinestraEsterna extends JFrame {
    ...
    public MiaFinestraEsterna(String titolo, int larghezza, int altezza){
        super(titolo);
        init(larghezza,altezza);
        initListener();
    }
    
    public MiaFinestraEsterna(String titolo){
        super(titolo);
        init(LARGHEZZA,ALTEZZA);
        initListener();
    } 
    ...
    private void initListener(){
        //ESTERNA
        btnConferma.addActionListener(new BtnListener());
