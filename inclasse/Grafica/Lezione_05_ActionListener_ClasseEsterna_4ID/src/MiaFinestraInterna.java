...
public class MiaFinestraInterna extends JFrame {
    ...
    public MiaFinestraInterna(String titolo, int larghezza, int altezza){
        super(titolo);
        init(larghezza,altezza);
        initListener();
    }
    
    public MiaFinestraInterna(String titolo){
        super(titolo);
        init(LARGHEZZA,ALTEZZA);
        initListener();
    } 
    ...
    private void initListener(){
        //INTERNA
        btnConferma.addActionListener(new BtnListener2());
        btnAnnulla.addActionListener(new BtnListener2());
    }
    ...
    private class BtnListener2 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(btnSorgente.getActionCommand().equals("esegui_conferma")) {
                System.out.println("Hai cliccato il pulsante CONFERMA. Sono l'ascoltatore della classe INTERNA");
            } else {
                System.out.println("Hai cliccato il pulsante ANNULLA. Sono l'ascoltatore della classe INTERNA");
            }
        }
    }
}
