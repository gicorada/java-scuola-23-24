...
public class Finestra extends JFrame {
    ...
    private void initListener() {
        ...
        btnGo2.addActionListener(new AscoltatoreEsterno(c, lblCont, txtCont, cbInc, cbDec));
        btnGo3.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if(combo.getSelectedItem().equals("Incrementa")) c.incrementa();
                else if(combo.getSelectedItem().equals("Decrementa")) c.decrementa();
                else if(combo.getSelectedItem().equals("Reset")) c.reset();
    ...
    private void init(int larghezza,int altezza) {
        ...
        txtCont = new JTextField(c.toString());
